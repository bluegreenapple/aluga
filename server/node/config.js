module.exports = {
  ...
  MONGO_URI: process.env.MONGO_URI || 'mongodb://rchung0:lala1@ds029197.mongolab.com:29197/scotch',
  FACEBOOK_SECRET: process.env.FACEBOOK_SECRET || '5de59a7c3c333d9a35f4492a2285ac5d',
