...
String.prototype.extenso = function(c,isFeminino){
	isFeminino = typeof isFeminino !== 'undefined' ? isFeminino : false; //isFeminino defaults to false
	var ex;

	if (isFeminino) 
	{
		ex = [
			["zero", "uma", "duas", "tres", "quatro", "cinco", "seis", "sete", "oito", "nove", "dez", "onze", "doze", "treze", "quatorze", "quinze", "dezesseis", "dezessete", "dezoito", "dezenove"],
